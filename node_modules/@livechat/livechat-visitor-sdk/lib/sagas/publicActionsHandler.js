...
var _sendMessage = require('./requests/sendMessage');

var _sendMessage2 = _interopRequireDefault(_sendMessage);

var _startChat = require('./requests/startChat');

var _startChat2 = _interopRequireDefault(_startChat);

var _closeChat = require('./requests/closeChat');

var _closeChat2 = _interopRequireDefault(_closeChat);
...
var _configSaga = require('../sagas/configSaga');
		...
		while (1) {
			switch (_context.prev = _context.next) {
				...
				case 2:
					...
					_context.next = 8;
					return (0, _effects.call)(_startChat2.default, {
						customId: customId,
						text: text
					});
				...
				case 10:
					_context.next = 12;
					return (0, _effects.call)(_sendMessage2.default, {
						customId: customId,
						text: text
					});
				...
				case 17:
					_context.next = 19;
					return (0, _effects.take)(function (reduxAction) {
						return reduxAction.type === chatActions.newMessage.getActionName() && (0, _get2.default)('payload.customId', reduxAction) === customId;
					});
		...
		while (1) {
			switch (_context2.prev = _context2.next) {
				...
				case 2:
					...
					parsedNewVisitorData = (0, _omitBy2.default)(_isNil2.default, (0, _pick2.default)(['name', 'email', 'pageUrl', 'pageTitle', 'customProperties'], action.payload));
					requestId = String(Math.random());
					newVisitorData = (0, _merge2.default)(visitorData, parsedNewVisitorData);
					_context2.next = 8;
				...
				case 8:
					_context2.next = 10;
					return (0, _effects.take)(function (anyAction) {
	...
	return regeneratorRuntime.wrap(function setSneakPeekHandler$(_context3) {
		while (1) {
			switch (_context3.prev = _context3.next) {
				case 0:
					_context3.next = 2;
					return (0, _effects.put)(_propsActions2.default.setPropertySneakPeek(action.payload.text));
	...
	return regeneratorRuntime.wrap(function forwardChatTranscriptHandler$(_context4) {
		while (1) {
			switch (_context4.prev = _context4.next) {
				...
				case 21:
					translatedIWCS = (0, _IWCSTranslator.translateToIWCS)('forwardChatTranscript', {
						visitorId: visitorId,
						chatId: chatId,
					...
					_context4.prev = 22;
					_context4.next = 25;
					return (0, _effects.call)(_serverRequest.sendIWCS, environment, license, translatedIWCS, securedToken, secretId);
		...
		while (1) {
			switch (_context5.prev = _context5.next) {
				...
				case 6:
					_context5.prev = 6;
					_context5.next = 9;
					return (0, _effects.call)(_closeChat2.default);
	...
	return regeneratorRuntime.wrap(function rateChatHandler$(_context6) {
		while (1) {
			switch (_context6.prev = _context6.next) {
				...
				case 18:
					translatedIWCS = (0, _IWCSTranslator.translateToIWCS)('rateChat', {
						visitorId: visitorId,
						chatId: chatId,
					...
					_context6.prev = 19;
					_context6.next = 22;
					return (0, _effects.call)(_serverRequest.sendIWCS, environment, license, translatedIWCS, securedToken);
				...
				case 28:
					_context6.next = 30;
					return (0, _effects.take)(chatActions.rateChat.getActionName());
				...
				case 30:
					...
					_context6.prev = 31;
					_context6.next = 34;
					return (0, _effects.call)(_serverRequest.sendPostToWebserv, 'send_rating_comment', {
	...
	return regeneratorRuntime.wrap(function getTicketFormHandler$(_context8) {
		while (1) {
			switch (_context8.prev = _context8.next) {
				case 0:
					_context8.next = 2;
					return (0, _effects.select)(_reducers.propsSelectors.getPropertyTicketForm);
				...
				case 2:
					...
					_context8.prev = 4;
					_context8.next = 7;
					return (0, _effects.call)(_configSaga.fetchTicketForm);
		...
		while (1) {
			switch (_context10.prev = _context10.next) {
				...
				case 14:
					...
					_context10.prev = 17;
					_context10.next = 20;
					return (0, _effects.call)(_serverRequest.sendPostToAPI, 'v2/tickets/new', {
						environment: environment,
						license: license,
						body: body
					});
	...
	return regeneratorRuntime.wrap(function _callee$(_context11) {
		while (1) {
			switch (_context11.prev = _context11.next) {
				case 0:
					_context11.next = 2;
					return (0, _effects.takeEvery)(publicSetVisitorData.getActionName(), setVisitorDataHandler);

				case 2:
					_context11.next = 4;
					return (0, _effects.takeEvery)(publicGetTicketForm.getActionName(), getTicketFormHandler);

				case 4:
					_context11.next = 6;
					return (0, _effects.takeEvery)(publicSendTicketForm.getActionName(), sendTicketFormHandler);

				case 6:
					_context11.next = 8;
					return (0, _effects.takeEvery)(publicRateChat.getActionName(), rateChatHandler);

				case 8:
					_context11.next = 10;
					return (0, _effects.takeEvery)(publicSetSneakPeek.getActionName(), setSneakPeekHandler);

				case 10:
					_context11.next = 12;
					return (0, _effects.takeEvery)(publicCloseChat.getActionName(), closeChatHandler);

				case 12:
					_context11.next = 14;
					return (0, _effects.takeEvery)(publicForwardChatTranscript.getActionName(), forwardChatTranscriptHandler);

				case 14:
					_context11.next = 16;
					return (0, _effects.takeEvery)(publicDisconnect.getActionName(), disconnectHandler);

				case 16:
					_context11.next = 18;
					return (0, _effects.takeEvery)(publicGetVisitorData.getActionName(), getVisitorDataHandler);

				case 18:
					_context11.next = 20;
					return (0, _effects.actionChannel)(publicSendMessage.getActionName(), _reduxSaga.buffers.expanding());
				...
				case 21:
					...
					_context11.next = 24;
					return (0, _effects.take)(sendMessageChannel);

				case 24:
					action = _context11.sent;
					_context11.next = 27;
					return (0, _effects.call)(sendMessageHandler, action);
